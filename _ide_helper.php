...
namespace {
    ...
    class RongCloud extends \Latrell\RongCloud\Facades\RongCloud{
        ...
        public static function getApi(){
            return \Latrell\RongCloud\RongCloud::getApi();
        }
        
    }


    class Cloud extends \Lance\Cloud\Facades\Cloud{
         ...
         * @param \Lance\Cloud\from  [主叫电话号码]
         * @param \Lance\Cloud\to  [被叫电话号码]
         * @param \Lance\Cloud\customerSerNum  [被叫侧显示的客服号码]
         * @param \Lance\Cloud\fromSerNum  [主叫侧显示的号码]
         * @param \Lance\Cloud\promptTone  [自定义回拨提示音]
         * @param \Lance\Cloud\alwaysPlay  [第三方私有数据]
         * @param \Lance\Cloud\terminalDtmf  [最大通话时长]
         * @param \Lance\Cloud\userData  [实时话单通知地址]
         * @param \Lance\Cloud\maxCallTime  [是否一直播放提示音]
         * @param \Lance\Cloud\hangupCdrUrl  [用于终止播放promptTone参数定义的提示音]
         * @param \Lance\Cloud\needBothCdr  [是否给主被叫发送话单]
         * @param \Lance\Cloud\needRecord  [是否录音]
         * @param \Lance\Cloud\countDownTime  [设置倒计时时间]
         * @param \Lance\Cloud\countDownPrompt  [倒计时时间到后播放的提示音]
         * @return \Lance\Cloud\[description] 
         * @static 
         */
        public static function callBack($from, $to, $options = array()){
            return \Lance\Cloud\CloudHandler::callBack($from, $to, $options);
        }
         ...
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function queryAccountInfo(){
            return \Lance\Cloud\CloudHandler::queryAccountInfo();
        }
         ...
         * @param \Lance\Cloud\[type] $friendlyName [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function createSubAccount($friendlyName){
            return \Lance\Cloud\CloudHandler::createSubAccount($friendlyName);
        }
         ...
         * @param \Lance\Cloud\[type] $startNo [description]
         * @param \Lance\Cloud\[type] $offset [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function getSubAccounts($startNo, $offset){
            return \Lance\Cloud\CloudHandler::getSubAccounts($startNo, $offset);
        }
         ...
         * @static 
         */
        public static function querySubAccount($friendlyName){
            return \Lance\Cloud\CloudHandler::querySubAccount($friendlyName);
        }
         ...
         * @param \Lance\Cloud\[type] $to [description]
         * @param \Lance\Cloud\[type] $datas [description]
         * @param \Lance\Cloud\[type] $tempId [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function sendTemplateSMS($to, $datas, $tempId){
            return \Lance\Cloud\CloudHandler::sendTemplateSMS($to, $datas, $tempId);
        }
         ...
         * @static 
         */
        public static function landingCall(){
            return \Lance\Cloud\CloudHandler::landingCall();
        }
         ...
         * @param \Lance\Cloud\[type] $verifyCode [description]
         * @param \Lance\Cloud\[type] $to [description]
         * @param \Lance\Cloud\[type] $playTimes [description]
         * @param \Lance\Cloud\[type] $displayNum [description]
         * @param \Lance\Cloud\[type] $respUrl [description]
         * @param \Lance\Cloud\[type] $lang [description]
         * @param \Lance\Cloud\[type] $userData [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function voiceVerify($verifyCode, $to, $playTimes, $displayNum, $respUrl, $lang, $userData){
            return \Lance\Cloud\CloudHandler::voiceVerify($verifyCode, $to, $playTimes, $displayNum, $respUrl, $lang, $userData);
        }
         ...
         * @param \Lance\Cloud\[type] $number [description]
         * @param \Lance\Cloud\[type] $userdata [description]
         * @param \Lance\Cloud\[type] $record [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function ivrDial($number, $userdata, $record){
            return \Lance\Cloud\CloudHandler::ivrDial($number, $userdata, $record);
        }
         ...
         * @static 
         */
        public static function billRecords($date = 'day', $keywords = ''){
            return \Lance\Cloud\CloudHandler::billRecords($date, $keywords);
        }
         ...
         * @param \Lance\Cloud\[type] $templateId [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function querySMSTemplate($templateId){
            return \Lance\Cloud\CloudHandler::querySMSTemplate($templateId);
        }
         ...
         * @param \Lance\Cloud\[type] $callSid [description]
         * @param \Lance\Cloud\[type] $type [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function callCancel($callSid, $type){
            return \Lance\Cloud\CloudHandler::callCancel($callSid, $type);
        }
         ...
         * @param \Lance\Cloud\[type] $callid [description]
         * @param \Lance\Cloud\[type] $action [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function queryCallState($callid, $action){
            return \Lance\Cloud\CloudHandler::queryCallState($callid, $action);
        }
         ...
         * @static 
         */
        public static function callResult($callSid){
            return \Lance\Cloud\CloudHandler::callResult($callSid);
        }
         ...
         * @param \Lance\Cloud\[type] $filename [description]
         * @param \Lance\Cloud\[type] $body [description]
         * @return \Lance\Cloud\[type] [description]
         * @static 
         */
        public static function mediaFileUpload($filename, $body){
            return \Lance\Cloud\CloudHandler::mediaFileUpload($filename, $body);
        }
